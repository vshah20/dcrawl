...
public class Server_1 {
	...
	static ArrayList<Map<String, Integer>> resultArray = new ArrayList<Map<String, Integer>>();
	static Map<String, Integer> duplicate = new HashMap<String, Integer>();
	static Map<String,PriorityQueue<WordCount>> results = new HashMap<String, PriorityQueue<WordCount>>();

	public Server_1(){};
	public void Fill_Index(Spider spider)
	{
		String dir = "www.gatech.edu";
...
//				System.out.println("Creating a Server1!");
	...
	private static boolean Broadcast_query(String query, LinkedList ll) throws RemoteException
        {
                try{
	...
	private static LinkedList LookUp_servers(String query) throws RemoteException
        {
	...
	public static void maintainResults(String[] resultm , String query)
	{
		try{
